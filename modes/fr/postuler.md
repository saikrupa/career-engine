...
5. **career-engine proof point** : inclure dans "Informations complementaires" si un tel champ existe
...
3. Suggerer l'etape suivante : `/career-engine contacto` pour du LinkedIn outreach vers le hiring manager
