...
import (
	...
	"github.com/santifer/career-engine/dashboard/internal/data"
	"github.com/santifer/career-engine/dashboard/internal/model"
	"github.com/santifer/career-engine/dashboard/internal/theme"
	"github.com/santifer/career-engine/dashboard/internal/ui/screens"
)
...
func main() {
	pathFlag := flag.String("path", ".", "Path to career-engine directory")
	flag.Parse()
